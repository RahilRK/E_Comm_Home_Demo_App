...
class ShowChosenForYouUseCase @Inject constructor(
    private val repository: DomainRepository
) {
    var TAG = "ShowChosenForYouUseCase"

    operator fun invoke(): LiveData<List<ChosenForYouDTO>> {
        return repository.getChosenForYou()
    }
}